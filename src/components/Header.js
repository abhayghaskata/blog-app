...
export default function Header() {
  ...
  console.log('AdminLogin', data.adminLogin)
      ...
      <div className="z-50">
        ...
        "
            >
              ...
              {data.adminLogin ? (
                <li className="text-red-400">Admin Panel</li>
              ) : (
                <div
      ...
      {!data.adminLogin && (
                    ...
                    {data.userLogin ? (
                      <li className="cursor-pointer " onClick={handleLogout}>
                        <div className="md:p-4 py-2 block hover:bg-red-500 hover:text-white">
                          logout
                        </div>
                      </li>
                    ) : (
                    ...
                    <li className="cursor-pointer" onClick={HandleBlog}>
                      <div className="md:p-4 py-2 block hover:bg-purple-300 hover:text-white">
                        My Blog
                      </div>
                    </li>
                    {data.userLogin && (
                      <li className="cursor-pointer" onClick={HandleAllBlog}>
                        <div className="md:p-4 py-2 block hover:bg-purple-300 hover:text-white">
                          Add Blog
                        </div>
                      </li>
                    ...
                    <li className="cursor-pointer" onClick={handleSignup}>
                      <div className="md:p-4 py-2 block hover:bg-purple-300 hover:text-white">
                        Sign Up
                      </div>
                    </li>
                    <li className="cursor-pointer" onClick={HandleAdminLogin}>
                      <div className="md:p-4 py-2 block hover:bg-purple-300 hover:text-white">
                        Admin Login
                      </div>
                    </li>
      ...
      {/* <Box sx={{ flexGrow: 1 }} className="dark:bg-gray-800 z-50">
        <AppBar position="static" className="dark:bg-gray-800 z-50">
          <Toolbar className="dark:bg-gray-800 z-50">
            ...
            <div color="inherit" onClick={handleSide} className="relative">
              <ContactMailIcon />
            ...
            {data.adminLogin && <p className="text-red-400">Admin</p>}
          </Toolbar>
        </AppBar>
      </Box> */}
    </>
